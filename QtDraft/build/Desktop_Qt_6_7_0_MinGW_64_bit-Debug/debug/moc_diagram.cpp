...
Q_CONSTINIT const QMetaObject Diagram::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDiagramENDCLASS_t,
        ...
        // method 'recieveDiagramVector'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<std::vector<_Data>, std::false_type>,
        // method 'on_Diagram_finished'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void Diagram::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->recieveDiagramVector((*reinterpret_cast< std::add_pointer_t<std::vector<_Data>>>(_a[1]))); break;
        case 1: _t->on_Diagram_finished((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
